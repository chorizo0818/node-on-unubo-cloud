...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, {
        ...
        let arry= me.getElementsAtEvent(e);
        /*
        if(arry[0]) {
          if(window.opener) {
            let odais = window.opener.document.getElementById('odais');
            odais.selectedIndex = 10 - arry[0]._index;
            window.opener.getOdaiInfo(odais);
          }else if(window.parent) {
            let odais = window.parent.document.getElementById('odais');
            odais.selectedIndex = 10 - arry[0]._index;
            window.parent.getOdaiInfo(odais);
          }else{
            let odais = document.getElementById('odais');
            odais.selectedIndex = 10 - arry[0]._index;
            window.getOdaiInfo(odais);
            console.log(arry[0]._index);
          }
        }
        */
...
//		footerFontStyle: "bold",
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		getBody: function(tooltipItems, data) {
			...
			return lines.concat(lastLine.split('\n'));
		},
